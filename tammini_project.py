# -*- coding: utf-8 -*-
"""tammini_project.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1dvKdLmck94fI6HOPb6YiaJmSBpVMdBya
"""
...
def show_landing_page():
    st.markdown("""
        ...
        <div class='landing-container'>
            ...
            <div class='note'>رفيقك لصحة نفسية أفضل — هذه المنصة تعتمد على الذكاء الاصطناعي لمساعدتك في فهم حالتك النفسية. نحن لا نقدم تشخيصاً بديلاً عن الطبيب بل أداة داعمة له.</div>
        </div>
...
def questionnaire():
    ...
    questions = {
        1: "س1: هل تجد نفسك تعاني من التفكير المفرط أو القلق الزائد تجاه مختلف الأمور الحياتية المحيطة بك، سواء كانت متعلقة بالعمل، الدراسة، المنزل، أو غيرها؟ اعطِ أمثلة على بعض من هذه الأمور وكيف يؤثر التفكير والقلق بها على أفكارك وسلوكك خلال اليوم.",
        2: "س2: هل تواجه صعوبة في السيطرة على أفكارك القلقة أو التحكم في مستوى القلق الذي تشعر به، بحيث تشعر أن الأمر خارج عن إرادتك أو أنه مستمر على نحو يرهقك؟ اجعل إجابتك تفصيلية بحيث توضح كيف يكون خارج عن إرادتك أو إلى أي مدى يرهقك؟",
    ...
    if st.button("إرسال التقييم"):
        if any(ans.strip() == "" for ans in answers.values()):
            ...
            if user:
                depression_score = random.randint(30, 100)
                anxiety_score = random.randint(20, 80)
                result = f"نسبة الاكتئاب: {depression_score}% — نسبة القلق: {anxiety_score}%"
